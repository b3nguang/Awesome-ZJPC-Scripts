t = [
  ...
  "http:",
  "/wengine-vpn",
  "/wengine-vpn/js/main.js",
  "wrdvpnisthebest!",
  "__vpn_protocol_host",
  "__vpn_hostname_data",
  "__vpn_protocol_data",
  "__vpn_app_hostname_data",
  "__vpn_app_port_data",
  "__vpn_app_protocol_data",
  "__vpn_js_file",
  "__vpn_worker_mode",
  "__vpn_host_crypt",
  "__vpn_host_crypt_key",
  "__vpn_host_crypt_iv",
  "app_port",
  "app_hostname",
  "vpn_protocol",
  ...
  "isInlineFunction",
  "wrapper",
  "var vpn_return;eval(vpn_rewrite_js((function () { ",
  " }).toString().slice(14, -2), 2));return vpn_return;",
  "this.top.vpn_inject_script(this);vpn_eval((function () { ",
  " }).toString().slice(14, -2))",
  "this.top.vpn_inject_scripts_window(this);vpn_eval((function () { ",
  "INLINE_FUNCTION_PREV",
  "INLINE_FUNCTION_POST",
  "INLINE_SCRIPT_PREV",
  "INLINE_SCRIPT_POST",
  "BACKEND_INLINE_SCRIPT_PREV",
  "inline",
  "acorn",
  "Assigning to rvalue",
  "lastIndexOf",
  ...
  "' has been blocked by CORS policy: Method ",
  "toUpperCase",
  " is not allowed by Access-Control-Allow-Methods in preflight response.",
  "Mixed Content: The page at '",
  "' was loaded over HTTPS, but requested an insecure XMLHttpRequest endpoint '",
  "'. This request has been blocked; the content must be served over HTTP.",
  "error xhr",
  "DOMException",
  ...
  "cookie",
  "refresh",
  "/cookie?method=get&host=",
  "&scheme=",
  "&path=",
  "&vpn_timestamp=",
  "refresh=0;path=/",
  "/cookie?method=set&host=",
  "&ck_data=",
  "refresh=1;path=/",
  "mixins",
  "assign",
  ...
  "MAX_SAFE_INTEGER",
  "integer value out of safe range",
  ...
  "regexp_eatCapturingGroup",
  "regexp_eatAtomEscape",
...
toBytes = function (n) {
  var i = [],
    e = 0;
  for (n = encodeURI(n); e < n[t[67]]; ) {
    var r = n[t[626]](e++);
    37 === r
      ? (i[t[50]](parseInt(n[t[614]](e, 2), 16)), (e += 2))
      : i[t[50]](r);
  }
  return s(i);
};
fromBytes = function (i) {
  var n = t[628];
  for (var e = [], r = 0; r < i[t[67]]; r++) {
    var s = i[r];
    e[t[50]](n[(240 & s) >> 4] + n[15 & s]);
  }
  return e[t[143]](t[70]);
};
h = function (n) {
  var i =
    t[508] ===
    (arguments[t[67]] > 1 && void 0 !== arguments[1] ? arguments[1] : t[508])
      ? 16
      : 32;
  if (n[t[67]] % i == 0) return n;
  for (var e = i - (n[t[67]] % i), r = 0; r++ < e; ) n += t[513];
  return n;
};
var T = function (n, i, e) {
  ...
  e || (e = 1),
    (this["segmentSize"] = e),
    (this["_shiftRegister"] = s(i, !0)),
    (this["_aes"] = new E(n));
};
T[t[22]][t[180]] = function (n) {
  if (n[t[67]] % this[t[648]] != 0) throw new Error(t[650]);
  for (var i, e = s(n, !0), r = 0; r < e[t[67]]; r += this[t[648]]) {
    i = this[t[639]][t[180]](this[t[649]]);
    for (var o = 0; o < this[t[648]]; o++) e[r + o] ^= i[o];
    a(this[t[649]], this[t[649]], 0, this[t[648]]),
      a(e, this[t[649]], 16 - this[t[648]], r, r + this[t[648]]);
  }
  return e;
};
main = function (n) {
  var i = "wrdvpnisthebest!",
    e = "wrdvpnisthebest!";
  var r = n[t[67]];
  n = h(n, t[508]);
  var s = toBytes(i),
    c = toBytes(e),
    f = toBytes(n),
    l = new T(s, c, 16)[t[180]](f);
  return fromBytes(c) + fromBytes(l)[t[96]](0, 2 * r);
};
function o(t) {
  return new Uint8Array(t);
}
function s(n, i) {
  if (n[t[622]] && t[623] === n[t[68]])
    return i && (n = n[t[96]] ? n[t[96]]() : Array[t[22]][t[96]][t[1]](n)), n;
  if (Array[t[77]](n)) {
    if (!r(n)) throw new Error(t[624] + n);
    return new Uint8Array(n);
  }
  if (e(n[t[67]]) && r(n)) return new Uint8Array(n);
  throw new Error(t[625]);
}
E = function (n) {
  if (!(this instanceof E)) throw Error(t[629]);
  Object[t[7]](this, t[361], {
    value: s(n, !0),
  }),
    this[t[630]]();
};
...
function r(n) {
  if (!e(n[t[67]])) return !1;
  for (var i = 0; i < n[t[67]]; i++)
    if (!e(n[i]) || n[i] < 0 || n[i] > 255) return !1;
  return !0;
}
E[t[22]][t[630]] = function () {
  var n = f[this[t[361]][t[67]]];
  if (null == n) throw new Error(t[631]);
  (this[t[632]] = []), (this[t[633]] = []);
  for (var i = 0; i <= n; i++)
    this[t[632]][t[50]]([0, 0, 0, 0]), this[t[633]][t[50]]([0, 0, 0, 0]);
  var e,
    r = 4 * (n + 1),
    s = this[t[361]][t[67]] / 4,
    o = u(this[t[361]]);
  for (i = 0; i < s; i++)
    (e = i >> 2),
      (this[t[632]][e][i % 4] = o[i]),
      (this[t[633]][n - e][i % 4] = o[i]);
  for (var a, h = 0, c = s; c < r; ) {
    if (
      ((a = o[s - 1]),
      (o[0] ^=
        (v[(a >> 16) & 255] << 24) ^
      ...
      for (i = 1; i < s; i++) o[i] ^= o[i - 1];
    else {
      for (i = 1; i < s / 2; i++) o[i] ^= o[i - 1];
      for (
        a = o[s / 2 - 1],
          o[s / 2] ^=
            v[255 & a] ^
...
function u(n) {
  for (var i = [], e = 0; e < n[t[67]]; e += 4)
    i[t[50]]((n[e] << 24) | (n[e + 1] << 16) | (n[e + 2] << 8) | n[e + 3]);
  return i;
}

E[t[22]][t[180]] = function (n) {
  if (16 != n[t[67]]) throw new Error(t[634]);
  for (
    var i = this[t[632]][t[67]] - 1, e = [0, 0, 0, 0], r = u(n), s = 0;
    s < 4;
    s++
  )
    r[s] ^= this[t[632]][0][s];
  ...
  for (s = 0; s < 4; s++)
    (h = this[t[632]][i][s]),
      (c[4 * s] = 255 & (v[(r[s] >> 24) & 255] ^ (h >> 24))),
      (c[4 * s + 1] = 255 & (v[(r[(s + 1) % 4] >> 16) & 255] ^ (h >> 16))),
      (c[4 * s + 2] = 255 & (v[(r[(s + 2) % 4] >> 8) & 255] ^ (h >> 8))),
      (c[4 * s + 3] = 255 & (v[255 & r[(s + 3) % 4]] ^ h));
  return c;
};
function a(n, i, e, r, s) {
  (null == r && null == s) ||
    (n = n[t[96]] ? n[t[96]](r, s) : Array[t[22]][t[96]][t[1]](n, r, s)),
    i[t[158]](n, e);
}

chrome.contextMenus.create({
  title: "使用浙江警察学院 WebVPN 访问本页",
  onclick: function () {
    Jump();
  },
});
...
function Jump() {
  chrome.tabs.query({ active: true, lastFocusedWindow: true }, function (tabs) {
    var url = tabs[0].url;
    //try {
    var arr = url.split("//")[1].split("/")[0]; //[0].split("//")[1];
    //}
    //catch(error) {
    //var arr = url.split("//")[1];
    //console.error(error);
    ...
    var head = url.split(":")[0],
      back = url.split(arr)[1];
    var body = main(arr);
    var Url = "https://webvpn.zjjcxy.cn/" + head + "/" + body + back;
    //alert(Url);
...
chrome.browserAction.onClicked.addListener(Jump);
